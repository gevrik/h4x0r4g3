...
class UtilityService extends BaseService
{
    ...
    public function showCommands($resourceId)
    {
        ...
        $message = 'addconnection  addnode  attack  bgopacity bug  cd  changepassword  clear  code  commands  connect  consider  deposit  dl  download  editnode  entityname  equipment  eset  execute  explore  factionchat fc  factionratings  factions  filemods  filename  filetypes  gc  help  home  idea  initarmor  inventory inv  jobs  kill  ls  mail  map  milkrun  newbie  nodename  nodes  nodetype  options  passwd  ps  removeconnection removenode  resources res  say  scan  score  secureconnection  setemail  setlocale  showbalance  skillpoints  skills  sneak  stat  stealth  survey  system  time  touch  typo  ul  unload  upgradenode  use  visible  vis  withdraw';
